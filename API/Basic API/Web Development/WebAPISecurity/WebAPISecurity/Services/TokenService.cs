...
{
    /// <summary>
    /// Provides methods for generating and validating JSON Web Tokens (JWT) for user authentication and authorization.
    /// The token generation includes user-related claims, and the validation ensures that the token is correctly signed and not expired.
    /// </summary>
    public static class TokenService
    {
        ...
        public static string GenerateToken(User user)
        {
            ...
            {
                new Claim("sub", user.Username),    // Subject (username)
